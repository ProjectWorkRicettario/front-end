...
const ProfilePage = () => {
  ...
  if (!profile && !loading) return <div className="error-msg">Errore: Dati utente non disponibili.</div>;
          ...
          <>
            ...
            <section className="profile-recipes-section">
              ...
              {recipesLoading ? (
                ...
                <div className="empty-state">Nessuna ricetta salvata nel tuo archivio.</div>
              ) : (
